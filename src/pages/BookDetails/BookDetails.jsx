...
const BookDetals = () => {
  ...
  const singleBook= allBooksData.find(book=> book.bookId===booksId);
  const {image,bookName,author,rating ,category,review,totalPages,publisher,yearOfPublishing, bookId} = singleBook
